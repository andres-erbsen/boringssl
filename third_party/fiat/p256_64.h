...
// NOTE: edited after generation
#if OPENSSL_HAS_BUILTIN(__builtin_ia32_addcarryx_u64)
  ...
  *out1 = t;
#elif OPENSSL_HAS_BUILTIN(__builtin_addcll)
  long long unsigned int t;
  *out1 = __builtin_addcll(arg2, arg3, arg1, &t);
  *out2 = t;
#else
  arg2 += arg1;
  arg1 = arg2 < arg1;
...
#if OPENSSL_HAS_BUILTIN(__builtin_ia32_subborrow_u64)
  long long unsigned int t;
  *out2 = __builtin_ia32_subborrow_u64(arg1, arg2, arg3, &t);
  *out1 = t;
#elif defined(_M_X64)
  long long unsigned int t;
  *out2 = _subborrow_u64(arg1, arg2, arg3, &t); // NOTE: edited after generation
  *out1 = t;
#elif OPENSSL_HAS_BUILTIN(__builtin_subcll)
  long long unsigned int t;
  *out1 = __builtin_subcll(arg2, arg3, arg1, &t);
  *out2 = t;
#else
  *out1 = arg2 - arg3 - arg1;
